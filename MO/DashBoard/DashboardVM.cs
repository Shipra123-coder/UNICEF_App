...
namespace MO.DashBoard
{
    ...
    {
        public int GoalId { get; set; }
        public int GoalDisplayNumber { get; set; }
    ...
    public class ViksitDashboardModel
    {
        public int ViksitId { get; set; }
        public string ViksitName { get; set; }
        public string ImageUrl { get; set; }
    ...
    public class ViksitDepartmentActivityModel
    {
        public int ViksitId { get; set; }
    ...
    public class ViksitAgencyActivityModel
    {
        public int ViksitId { get; set; }
    ...
    public class ViksitSectorActivityModel
    {
        public int ViksitId { get; set; }
