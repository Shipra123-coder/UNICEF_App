var sdggoals = {
    loadCoverPagesByGoals: function () {
        var GoalId = $('#hiddenGoalId').val();

        $.ajax({
            url: `/SDGProgress/GetCoverPagesByViksit?goalId=${GoalId}`,
            type: 'GET',
    ...
    loadDepartmentActivityList: function (goalId) {

        $.ajax({
            url: `/SDGProgress/GetDepartmentActivityList?goalId=${goalId}`,
            type: 'GET',
    ...
    loadSectorActivityList: function (goalId) {

        $.ajax({
            url: `/SDGProgress/GetSectorActivityList?goalId=${goalId}`,
            type: 'GET',
    ...
    loadAgencyActivityList: function (goalId) {
        $.ajax({
            url: `/SDGProgress/GetAgencyActivityList?goalId=${goalId}`,
            type: 'GET',
    ...
    loadActivityList: function (goalId) {
